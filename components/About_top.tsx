            ...
            <div className="grid grid-cols-12 p-2">
              <div className="md:col-span-6 col-span-12">
                <p className="about-p">
                  ...
                  about the process, provide them with accurate treatment quotes
                  from desired facilities, and ensure they have a seamless
                  experience throughout the treatment and recovery process.
                  After their treatment and return back home, we follow-up to
                  ensure they continue their recovery process based on the
                  treating doctor’s prescription/recommendation.
                </p>
              </div>

              <div className="md:col-span-6 col-span-12">
                <p className="about-p">
                  At AMT, we understand that the treatment process in a foreign
                  country can be daunting for first-time or even repeat
                  patients. AMT’s primary concern is the patient and their
                  family’s peace of mind. We focus on the logistics and
                  administrative tasks allowing our patients to focus entirely
                  on treatment and recovery. By carrying this burden for them,
                  we ensure that the treatment progresses much more effectively,
                  quickly and with higher chances of successful outcomes.
                </p>
              </div>
            </div>
          </div>
