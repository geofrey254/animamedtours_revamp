...
const Foot = () => {
  ...
  return (
    <footer className="footer-section w-full md:p-0 p-4">
            ...
            <div className="md:col-span-4 col-span-12 mb-8">
              <div className="single-cta">
                ...
                <div className="cta-text">
                  <h4>Find us</h4>
                  <span>Madonna House, 3rd Floor, Suite 315, Westlands Rd</span>
                </div>
              </div>
            </div>
            <div className="md:col-span-4 col-span-12 mb-8">
              ...
              <div className="footer-widget">
                ...
                <div className="footer-text mb-25">
                  <p>
                    ...
                    <br />
                    <span className="text-light">Westlands Rd, Westlands</span>
                  </p>
                </div>
              </div>
            </div>
